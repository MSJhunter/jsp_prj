...
<head></head>
<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="http://192.168.10.222/jsp_prj/common/css/common.css" />
<link rel="stylesheet" type="text/css" href="http://192.168.10.222/jsp_prj/common/css/main.css" />
<script type="text/javascript" src="http://192.168.10.222/jsp_prj/common/js/jquery-1.8.0.min.js"></script>
<script type="text/javascript" src="http://192.168.10.222/jsp_prj/common/js/menu.js"></script>
<meta http-equiv="Content-Type" content="text/html;charset=euc-kr" />
<meta http-equiv="X-UA-Compatible" content="IE=Edge" />
<meta property="og:image" content="http://192.168.10.222/jsp_prj/project_tr/images/sns_tlj_logo.jpg" />
...
<title>건강한 데일리 베이커리, 빵, 케이크, 샌드위치, 이벤트, 매장안내</title>
	<div>
	<jsp:include page="../project_tr/header.jsp"/>
	</div>
	<div class="main-slider4">
		<ul>
			<li class="img_main2"><img src="http://192.168.10.222/jsp_prj/project_tr/images/img_main2.jpg" width="1400px" height="606px" alt="건강한 데일리 베이커리 - 건강하지만, 맛있어야, 맛있지만, 건강해야, 매일 먹을 수 있다는 평범한 원칙으로부터 뚜레쥬르의 오늘은 시작됩니다."/></li>
		</ul>
	</div>
	<div align="center">
		...
		<ul>
			<li>
				<a href="장바구니">
				<img alt="" src="http://192.168.10.222/jsp_prj/project_tr/images/img_banner4.png" >
				</a>
				<a href="제품">
				<img alt="" src="http://192.168.10.222/jsp_prj/project_tr/images/img_banner5.jpg">
				</a>
			</li>
		</ul>
...
<ul>
<li>
    <img src="http://192.168.10.222/jsp_prj/project_tr/images/trz.png" style="width: 100%; display: block; filter: brightness(0.5);">
    <div class="store_find" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 10; text-align: center;">
        ...
        <fieldset class="srch_form" style="display: inline-block;">
            ...
            <form name="store" action="/store/search.asp" onsubmit="return goStore(store);" style="margin-right: 195px; margin-top: -60px">
                ...
                <input type="image" src="http://192.168.10.222/jsp_prj/project_tr/images/btn_search.gif" class="btn_search" title="검색" alt="검색" />
            </form>
        	 ...
        	 <div class="new_div" style="text-align: center; margin-left:602px; margin-top: -226.7px; width: 390px; height: 270px; background-color: #333333">
  					<a href="매장안내"><img src="http://192.168.10.222/jsp_prj/project_tr/images/market_info.png" width="390px" height="270px" style="display: block; filter: brightness(0.8);"></a>
...
<script type="text/javascript">
	...
	<jsp:include page="/project_tr/footer.jsp"/>
