...
.store_map {
	...
	background-image: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),
		url("/jsp_prj/1_project/image/brandstore.jpg");
...
<body>
	<div id="wrap">
		...
		<div id="header">
			<h1 class="logo">
				<img src="/jsp_prj/1_project/image/logo.png" alt="뚜레쥬르 로고">
			</h1>
		</div>
		<div id="button">
			...
			<div id="content">
				<div class="store_search">
					<form>
						...
						<button type="reset">
							<img src="/jsp_prj/1_project/image/reset.png">초기화
						</button>
						<button type="submit">
							<img src="/jsp_prj/1_project/image/search.png">검색
						</button>
					</form>
				</div>
					...
					<div class="store_map">
						<div class="in">
							...
							<span class="btn_more"><img
								src="/jsp_prj/1_project/image/plus(2).png"><a href="#"
								id="smallLink"></a></span>
						</div>
					</div>
				</div>
