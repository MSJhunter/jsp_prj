...
<link rel="stylesheet" type="text/css" href="http://192.168.10.221/html_prj/common/css/main_20240911.css"/>
<!-- bootstrap CDN 시작-->
...
<body>
	...
	<form name="memberFrm" id="memberFrm" method="get" action="parameter_values_join_frm.jsp" >
	<div align="center">
	<h1>회원가입</h1>
		<table>
			<!-- id 입력 -->
			...
			<tr>
				...
				<td>
					<input type="text" name="birth" id="birth" class="inputBox"  maxlength="10" style="width: 150px">
			</tr>
			<tr>
				<td>연락처</td>
