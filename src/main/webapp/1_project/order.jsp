<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" info="주문내역 "%>
<!DOCTYPE html>
<html>
<head>
    <title>주문내역</title>
...
.store_map {
	...
	background-image: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),
		url("/jsp_prj/day1011/image/brandstore.jpg");
        ...
        <div class="container">
            <div id="content">
                ...
                <div class="store_search">
                    ...
                    <input type="text" id="keyword" name="keyword" placeholder="주문한 상품을 검색해주세요.">
