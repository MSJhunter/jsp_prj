...
#store_find{
 background-image: "http://192.168.10.222/jsp_prj/project_tr/images/trz.png";
}
.store_find{
 background-image: "http://192.168.10.222/jsp_prj/project_tr/images/trz.png";
}
...
<body class="main reform">
	<div id="header" >
		...
		<div class="headerWrap">
			<h1 class="logo"><a href="링크넣어야됨"><img src="http://192.168.10.222/jsp_prj/project_tr/images/logo.png" alt="뚜레쥬르 로고" /></a></h1><!-- 201607 -->
			<ul class="top_search">
				<li>
					...
					<fieldset>
						...
						<form name="srch" method="get" action="/product/result.asp" onsubmit="return srchCheck(srch);" style="margin-left: -120px;">
							...
							<a href="#prod_name" id="btnSearch" class="btn_search" onclick="prodSrch(srch); return false"><img src="http://192.168.10.222/jsp_prj/project_tr/images/btn_search1.png" title="검색" alt="검색" /></a>
			...
			<ul class="tnb">
				<li style="/*display:none;*/">
					<a href="매장안내링크넣어주세요" class="tnb_store"><img src="http://localhost/jsp_prj/project_tr/images/info_market.png"></a>
					<a href="고객센터링크넣어주세요" class="tnb_customer"><img src="http://localhost/jsp_prj/project_tr/images/faq.png"></a>
					<a href="로그인링크넣어주세요" class="tnb_login"><img src="http://localhost/jsp_prj/project_tr/images/login_btn.png"></a>
				</li>
			</ul>
			<!-- //TopNavigationBar -->
			<!-- GNB -->
	...
	<p id="back-top">
		<a href="#top"><img src="http://localhost/jsp_prj/project_tr/images/top.png" style="opacity: 50%; outline: none; border: none; display: block;"><span></span></a>
	</p>